...
"""
    ...
    def do_GET(self):
        ...
        user_query = params.get("query", [""])[0].strip().lower()
        if user_query:
            ...
            response_content = self.render_html_page(results_html, speed_metric, query_val=user_query)
