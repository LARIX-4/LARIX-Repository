...
class LarixServer(BaseHTTPRequestHandler):
    ...
    def render_html_page(self, results_html="", speed_metric="", query_val=""):
        ...
        <head>
            ...
            <style>
                body {{ font-family: Arial, sans-serif; background-color: #ffffff; color: #1e392a; margin: 0; padding: 20px; }}
                .container {{ max-width: 800px; margin: 0 auto; text-align: center; padding-top: 20px; }}
                
                .logo-container {{ margin-bottom: 15px; }}
                .logo-img {{ width: 120px; height: 120px; border-radius: 50%; object-fit: cover; background-color: #e8f5e9; border: 3px solid #2e6f40; }}
                ...
                .nav-link {{ background-color: transparent; border: 2px solid #2e6f40; color: #2e6f40; font-weight: bold; font-size: 14px; cursor: pointer; padding: 8px 20px; border-radius: 20px; transition: all 0.3s ease; }}
                ...
                .result-card {{ border: 1px solid #c8e6c9; padding: 20px; border-radius: 4px; margin-bottom: 15px; background-color: #fafafa; }}
                ...
                .result-snippet {{ background-color: #ffffff; border-left: 4px solid #2e6f40; padding: 12px; margin: 10px 0; font-size: 15px; line-height: 1.5; color: #111; }}
