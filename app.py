                ...
                for item in matched_items:
                    ...
                    results_html += f"""<div class="result-card">
                        ...
                        <div style="font-size:14px; color:#555; margin:8px 0; line-height:1.4; text-align:justify;">
                            <strong>Abstract:</strong> {abstract_text}
                        </div>
                        <div class="result-snippet"><strong>Ready-to-Use RRL Snippet:</strong><br>"{snippet_text}"</div>
                        <a class="result-link" href="{link_url}" target="_blank">View Verified Source Link</a>
                    </div>"""
            else: 
                results_html = "<p style='text-align: center; color: #cc0000; font-weight: bold; background: #ffebee; padding: 15px; border-radius: 4px; border-left: 4px solid #cc0000;'>No results found related to your keyword. Please try another term.</p>"
