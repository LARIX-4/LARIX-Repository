...
class LarixServer(BaseHTTPRequestHandler):
    ...
    def render_html_page(self, results_html="", speed_metric="", query_val=""):
        html_top = f"""<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>LARIX Repository | Guisguis NHS</title><style>
